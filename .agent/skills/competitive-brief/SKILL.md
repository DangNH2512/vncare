...
description: Dựng bản phân tích cạnh tranh cho một hoặc nhiều đối thủ, hoặc cho một mảng tính năng của Da Nang Connect. Dùng khi cần định hướng chiến lược sản phẩm, ưu tiên tính năng, chuẩn bị tài liệu cho nhà đầu tư, hoặc quyết định chỗ nào nên khác biệt và chỗ nào chỉ cần ngang bằng đối thủ.
---
...
- **Bộ đối thủ mặc định (nền tảng sự kiện & kết nối cộng đồng):**
  - **Meetup** — chuẩn ngành về nhóm sở thích và sự kiện định kỳ; có nhóm expat tại Đà Nẵng nhưng nhóm sống thật rất thưa.
  - **Facebook Groups** — nơi cộng đồng expat Đà Nẵng thực sự đang ở; đối thủ mạnh nhất chính là hành vi "cứ đăng lên group". Không có RSVP đáng tin, không có hồ sơ tin cậy, tìm kiếm gần như vô dụng.
  - **Luma (lu.ma)** — trang sự kiện đẹp, RSVP nhẹ, mạnh với dân tech/nomad; yếu ở khám phá theo địa lý và ở việc giữ chân cộng đồng.
  - **InterNations** — mạng expat toàn cầu có sự kiện chính thức, thu phí hội viên; định vị cao cấp, thiên về networking hơn là sinh hoạt hằng ngày.
  - **Eventbrite** — bán vé và sự kiện quy mô lớn; nặng về thương mại, không phục vụ buổi cà phê 8 người ở An Thượng.
  - **Timeleft** — ghép bàn ăn tối cho người lạ; đối thủ trực tiếp ở nhu cầu "gặp người mới", nhưng chỉ một format duy nhất.
  - **Không tiêu dùng / kênh thay thế:** group Zalo, Discord/WhatsApp riêng, bảng tin quán cà phê, câu lạc bộ thể thao tự phát, dịch vụ ghép bạn tập/ghép bạn học ngôn ngữ.
- **Trục khác biệt cần soi:**
  - Chuyên biệt theo địa phương (Đà Nẵng, lọc theo khu vực My Khe / An Thuong / My An / Hai Chau / Son Tra / Ngu Hanh Son và theo bán kính) so với nền tảng toàn cầu chỉ lọc theo thành phố.
  - Song ngữ EN/VI với EN là mặc định — cầu nối giữa expat và người Việt bản địa, mảng mà Meetup và Luma không chạm tới.
  - Độ tin cậy: xác minh danh tính, trust level, tỉ lệ no-show công khai — trả lời nỗi sợ "gặp người lạ" mà Facebook Groups không giải quyết được.
...
**Trục dùng được ngay cho Da Nang Connect**:
- Toàn cầu vs siêu địa phương (Meetup/Eventbrite ở một đầu, chúng ta ở đầu kia)
- Chỉ tiếng Anh vs song ngữ EN/VI thật sự
- Ai cũng vào được vs có xác minh danh tính và trust level
- Một format duy nhất (Timeleft) vs nhiều loại sự kiện (thể thao, trao đổi ngôn ngữ, ăn uống, workshop)
- Bán vé/thương mại vs sinh hoạt cộng đồng miễn phí
- Chỉ web vs có mobile app kèm push notification
...
**Mảng năng lực nên so cho Giai đoạn 1** (dùng đúng bộ này để các bản brief so
sánh được với nhau qua thời gian):

```
| Capability Area          | Da Nang Connect | Meetup | Facebook Groups | Luma | InterNations | Eventbrite | Timeleft |
|--------------------------|-----------------|--------|-----------------|------|--------------|-----------|----------|
| Event discovery          |                 |        |                 |      |              |           |          |
|   Lọc theo khu vực/bán kính |              |        |                 |      |              |           |          |
|   Lọc theo danh mục & thời gian |          |        |                 |      |              |           |          |
| RSVP & attendance        |                 |        |                 |      |              |           |          |
|   Hàng chờ khi hết chỗ   |                 |        |                 |      |              |           |          |
|   Nhắc lịch & chống no-show |              |        |                 |      |              |           |          |
| Trust & safety           |                 |        |                 |      |              |           |          |
|   Xác minh danh tính     |                 |        |                 |      |              |           |          |
...
- Với Da Nang Connect, "review của khách hàng" tốt nhất không nằm trên G2 mà nằm
  trong các group Facebook expat Đà Nẵng, subreddit du mục số và bình luận App Store
  của Meetup/Luma. Đọc nguyên văn lời than phiền về no-show, nhóm chết, và cảm giác
  không an toàn khi gặp người lạ.
- Đừng đánh giá thấp "không tiêu dùng". Một group Facebook miễn phí đã có 40.000
  thành viên là đối thủ khó hơn bất kỳ SaaS nào trong bảng.
